...
values
  ('e0000000-0000-0000-0000-000000000001',
   ...
   (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '2 days 18 hours') AT TIME ZONE 'America/Chicago', (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '2 days 22 hours') AT TIME ZONE 'America/Chicago',
  ...
  ('e0000000-0000-0000-0000-000000000002',
   ...
   'gaming_party', array['Mario Kart 8 Deluxe'], array['Switch'],
   (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '4 days 19 hours') AT TIME ZONE 'America/Chicago', (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '4 days 23 hours') AT TIME ZONE 'America/Chicago',
  ...
  ('e0000000-0000-0000-0000-000000000003',
   ...
   'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=1200&q=80',
   'gaming_party', array['Super Mario World','Street Fighter II','F-Zero'], array['SNES'],
   (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '6 days 14 hours') AT TIME ZONE 'America/Chicago', (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '6 days 18 hours') AT TIME ZONE 'America/Chicago',
  ...
  ('e0000000-0000-0000-0000-000000000004',
   ...
   (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '9 days 12 hours') AT TIME ZONE 'America/Chicago', (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '9 days 22 hours') AT TIME ZONE 'America/Chicago',
  ...
  ('e0000000-0000-0000-0000-000000000005',
   ...
   'https://images.unsplash.com/photo-1493711662062-fa541adb3fc8?w=1200&q=80',
   'gaming_party', array['Stardew Valley','Animal Crossing: New Horizons','Balatro'], array['Switch','Steam Deck'],
   (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '3 days 18 hours') AT TIME ZONE 'America/Chicago', (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '3 days 21 hours') AT TIME ZONE 'America/Chicago',
  ...
  ('e0000000-0000-0000-0000-000000000006',
   ...
   'gaming_party', array['Street Fighter 6','Super Smash Bros. Ultimate'], array['PS5','Switch'],
   (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '5 days 18 hours') AT TIME ZONE 'America/Chicago', (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '5 days 21 hours') AT TIME ZONE 'America/Chicago',
   'Logan Arcade', '2410 W Fullerton Ave, Chicago, IL', 41.9247, -87.6889,
  ...
  ('e0000000-0000-0000-0000-000000000007',
   ...
   'gaming_party', array['Mario Party Superstars'], array['Switch'],
   (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '11 days 19 hours') AT TIME ZONE 'America/Chicago', (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '11 days 23 hours') AT TIME ZONE 'America/Chicago',
  ...
  ('e0000000-0000-0000-0000-000000000008',
   ...
   'gaming_party', array['Rocket League'], array['PC'],
   (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '1 day 19 hours') AT TIME ZONE 'America/Chicago', (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '1 day 22 hours') AT TIME ZONE 'America/Chicago',
   'Ignite Gaming Lounge', '3341 N Elston Ave, Chicago, IL', 41.9420, -87.7040,
  ...
  ('e0000000-0000-0000-0000-000000000010',
   ...
   array[]::text[],
   (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '7 days 16 hours') AT TIME ZONE 'America/Chicago',
   (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '7 days 21 hours') AT TIME ZONE 'America/Chicago',
  ...
  ('e0000000-0000-0000-0000-000000000011',
   ...
   array[]::text[],
   (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '2 days 18 hours') AT TIME ZONE 'America/Chicago',
   (date_trunc('day', now() AT TIME ZONE 'America/Chicago') + interval '2 days 22 hours') AT TIME ZONE 'America/Chicago',
   'Kopi Café', '5317 N Clark St, Chicago, IL', 41.9790, -87.6684,
   16, 0, 'all',
